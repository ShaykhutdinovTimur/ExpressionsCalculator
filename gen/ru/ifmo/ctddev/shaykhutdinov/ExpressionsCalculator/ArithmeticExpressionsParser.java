...
public class ArithmeticExpressionsParser extends Parser {
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__2) | (1L << VAR) | (1L << INT) | (1L << SUB))) != 0) );
			}
		}
	...
	public static class ExpressionOnlyContext extends StatContext {
		public ExprContext expr() {
			return getRuleContext(ExprContext.class,0);
		}
		public TerminalNode NEWLINE() { return getToken(ArithmeticExpressionsParser.NEWLINE, 0); }
		public ExpressionOnlyContext(StatContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ArithmeticExpressionsListener ) ((ArithmeticExpressionsListener)listener).enterExpressionOnly(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ArithmeticExpressionsListener ) ((ArithmeticExpressionsListener)listener).exitExpressionOnly(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ArithmeticExpressionsVisitor ) return ((ArithmeticExpressionsVisitor<? extends T>)visitor).visitExpressionOnly(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class AdditionOrSubtractContext extends ExprContext {
		public Token op;
		public ExprContext expr() {
			return getRuleContext(ExprContext.class,0);
		}
		...
		public AdditionOrSubtractContext(ExprContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ArithmeticExpressionsListener ) ((ArithmeticExpressionsListener)listener).enterAdditionOrSubtract(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ArithmeticExpressionsListener ) ((ArithmeticExpressionsListener)listener).exitAdditionOrSubtract(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ArithmeticExpressionsVisitor ) return ((ArithmeticExpressionsVisitor<? extends T>)visitor).visitAdditionOrSubtract(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class AdditionOrSubtractTermContext extends ExprContext {
		public TermContext term() {
			return getRuleContext(TermContext.class,0);
		}
		public AdditionOrSubtractTermContext(ExprContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ArithmeticExpressionsListener ) ((ArithmeticExpressionsListener)listener).enterAdditionOrSubtractTerm(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ArithmeticExpressionsListener ) ((ArithmeticExpressionsListener)listener).exitAdditionOrSubtractTerm(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ArithmeticExpressionsVisitor ) return ((ArithmeticExpressionsVisitor<? extends T>)visitor).visitAdditionOrSubtractTerm(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			{
			{
			_localctx = new AdditionOrSubtractTermContext(_localctx);
			_ctx = _localctx;
			_prevctx = _localctx;
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					{
					{
					_localctx = new AdditionOrSubtractContext(new ExprContext(_parentctx, _parentState));
					pushNewRecursionContext(_localctx, _startState, RULE_expr);
					setState(32);
					if (!(precpred(_ctx, 2))) throw new FailedPredicateException(this, "precpred(_ctx, 2)");
					setState(33);
					((AdditionOrSubtractContext)_localctx).op = _input.LT(1);
					_la = _input.LA(1);
					if ( !(_la==ADD || _la==SUB) ) {
						((AdditionOrSubtractContext)_localctx).op = (Token)_errHandler.recoverInline(this);
					} else {
						consume();
					}
					setState(34);
	...
	public static class MultiplicationOrDivisionContext extends TermContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ArithmeticExpressionsListener ) ((ArithmeticExpressionsListener)listener).enterMultiplicationOrDivision(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ArithmeticExpressionsListener ) ((ArithmeticExpressionsListener)listener).exitMultiplicationOrDivision(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ArithmeticExpressionsVisitor ) return ((ArithmeticExpressionsVisitor<? extends T>)visitor).visitMultiplicationOrDivision(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class MultiplicationOrDivisionDegContext extends TermContext {
		public FactorContext factor() {
			return getRuleContext(FactorContext.class,0);
		}
		public MultiplicationOrDivisionDegContext(TermContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ArithmeticExpressionsListener ) ((ArithmeticExpressionsListener)listener).enterMultiplicationOrDivisionDeg(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ArithmeticExpressionsListener ) ((ArithmeticExpressionsListener)listener).exitMultiplicationOrDivisionDeg(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ArithmeticExpressionsVisitor ) return ((ArithmeticExpressionsVisitor<? extends T>)visitor).visitMultiplicationOrDivisionDeg(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	private TermContext term(int _p) throws RecognitionException {
		...
		try {
			...
			{
			{
			_localctx = new MultiplicationOrDivisionDegContext(_localctx);
			_ctx = _localctx;
			_prevctx = _localctx;
	...
	public static class FactorDegContext extends FactorContext {
		...
		public TerminalNode EXP() { return getToken(ArithmeticExpressionsParser.EXP, 0); }
		public FactorContext factor() {
			return getRuleContext(FactorContext.class,0);
		}
	...
	public static class SimpleFactorContext extends FactorContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ArithmeticExpressionsListener ) ((ArithmeticExpressionsListener)listener).enterSimpleFactor(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ArithmeticExpressionsListener ) ((ArithmeticExpressionsListener)listener).exitSimpleFactor(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ArithmeticExpressionsVisitor ) return ((ArithmeticExpressionsVisitor<? extends T>)visitor).visitSimpleFactor(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static final String _serializedATN =
		...
		"\3\2\13\fO\2\17\3\2\2\2\4\35\3\2\2\2\6\37\3\2\2\2\b*\3\2\2\2\n:\3\2\2"+
		"\2\fJ\3\2\2\2\16\20\5\4\3\2\17\16\3\2\2\2\20\21\3\2\2\2\21\17\3\2\2\2"+
		"\21\22\3\2\2\2\22\3\3\2\2\2\23\24\7\7\2\2\24\25\7\3\2\2\25\26\5\6\4\2"+
		"\26\27\7\4\2\2\27\30\7\t\2\2\30\36\3\2\2\2\31\32\5\6\4\2\32\33\7\4\2\2"+
		"\33\34\7\t\2\2\34\36\3\2\2\2\35\23\3\2\2\2\35\31\3\2\2\2\36\5\3\2\2\2"+
		"\37 \b\4\1\2 !\5\b\5\2!\'\3\2\2\2\"#\f\4\2\2#$\t\2\2\2$&\5\b\5\2%\"\3"+
		"\2\2\2&)\3\2\2\2\'%\3\2\2\2\'(\3\2\2\2(\7\3\2\2\2)\'\3\2\2\2*+\b\5\1\2"+
		"+,\5\n\6\2,\62\3\2\2\2-.\f\4\2\2./\t\3\2\2/\61\5\n\6\2\60-\3\2\2\2\61"+
		"\64\3\2\2\2\62\60\3\2\2\2\62\63\3\2\2\2\63\t\3\2\2\2\64\62\3\2\2\2\65"+
		"\66\5\f\7\2\66\67\7\17\2\2\678\5\n\6\28;\3\2\2\29;\5\f\7\2:\65\3\2\2\2"+
		":9\3\2\2\2;\13\3\2\2\2<K\7\b\2\2=@\7\16\2\2>@\3\2\2\2?=\3\2\2\2?>\3\2"+
		"\2\2@A\3\2\2\2AK\7\7\2\2BE\7\16\2\2CE\3\2\2\2DB\3\2\2\2DC\3\2\2\2EF\3"+
		"\2\2\2FG\7\5\2\2GH\5\6\4\2HI\7\6\2\2IK\3\2\2\2J<\3\2\2\2J?\3\2\2\2JD\3"+
		"\2\2\2K\r\3\2\2\2\n\21\35\'\62:?DJ";
